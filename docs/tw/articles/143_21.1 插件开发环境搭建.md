...
**CPU**|  2核以上| 4核以上
**架構**|  x86_64 或 arm64| x86_64 或 arm64
**記憶體**|  4GB 以上| 8GB 以上
**磁碟**|  10GB 可用空間| 20GB 可用空間
...
從 [Python 官方網站](https://www.python.org/downloads/) 下載安裝程式。
...
從 [Git 官方網站](https://git-scm.com/downloads) 下載安裝程式。
